...
import { CustomTypeBuilder } from './customTypeBuilder';
 ...
 export class TypeFactory {
    ...
    private registerBuiltIns(): void {
        ...
        this.register('Microsoft.CLDialog', new ConfigurableTypeBuilder(CLDialog));
